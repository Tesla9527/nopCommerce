...
namespace Nop.Plugin.Tax.FixedOrByCountryStateZip.Infrastructure.Cache
{
    ...
    {
        /// <summary>
        /// Key for caching of all tax rates
        /// </summary>
        public const string TAX_RATES_ALL_MODEL_KEY = "Nop.plugins.tax.fixedorbycountrystateziptaxrate.all";

        /// <summary>
        /// Key for caching of all tax rates (paged) 
        /// </summary>
        /// <remarks>
        /// {0} : page index
        /// {1} : page size
        /// </remarks>
        public const string TAX_RATES_ALL_PAGED_MODEL_KEY = "Nop.plugins.tax.fixedorbycountrystateziptaxrate.allpaged-{0}-{1}";

        public const string TAX_RATES_PATTERN_KEY = "Nop.plugins.tax.fixedorbycountrystateziptaxrate.";
        ...
        {
            _cacheManager.RemoveByPattern(TAX_RATES_PATTERN_KEY);
        }
